        ...
        for speech in speeches:
            ...
            if "key" in speech.keys() and speech["key"] is not None:
                if speech["key"] in keys:
                    raise ValueError(
                        f"Unable to add new speech with parameter "
                        f'key="{speech["key"]}" '
            ...
            if "title" in speech.keys():
                ...
                raise ValueError(
                    f"Unable to add new speech " f'because a parameter "title" does not exist.'
                )
            ...
            if "start_time" in speech.keys():
                ...
                raise ValueError(
                    f"Unable to add new speech " f'because a parameter "start_time" does not exist.'
                )
            ...
            if "end_time" in speech.keys():
                ...
                raise ValueError(
                    f"Unable to add new speech " f'because a parameter "end_time" does not exist.'
                )
            ...
            if "venue" in speech.keys():
                ...
                raise ValueError(
                    f"Unable to add new speech " f'because a parameter "venue" does not exist.'
                )
        ...
        for speech in speeches:
            if new_key != "":
                if new_key not in keys:
                    ...
                    ValueError(
                        f"Unable to update the value in speech "
